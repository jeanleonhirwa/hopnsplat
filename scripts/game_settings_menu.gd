...
func _ready():
	...
	music_toggle = get_node_or_null("Panel/VBoxContainer/AudioSection/MusicContainer/HBoxContainer1/MusicToggle")
	sfx_toggle = get_node_or_null("Panel/VBoxContainer/AudioSection/SFXContainer/HBoxContainer2/SFXToggle")
